package com.chenqiao.controlclient.view;
...
import com.chenqiao.controlclient.R;
...
public class ControlView extends View {
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        ...
        // 可移动区域背景
        Drawable areaBackground = typedArray.getDrawable(R.styleable.controlview_areaBackground);
        ...
        // 摇杆背景
        Drawable rockerBackground = typedArray.getDrawable(R.styleable.controlview_rockerBackground);
        ...
        // 摇杆半径
        mRockerRadius = typedArray.getDimensionPixelOffset(R.styleable.controlview_rockerRadius, DEFAULT_ROCKER_RADIUS);
